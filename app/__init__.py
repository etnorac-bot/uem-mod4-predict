...
# Nombre de los servicios en IBM Cloud
CLOUDANT_DB = 'models-db'
BUCKET_NAME = 'depo-cos-uem'

# Nombre de los archivos y key de json de configuracion en IBM Cloud
FILE_MODEL_CONFIG = 'model_config'
FILE_IMG_PROS_CONFIG = 'img_pros_config'
